...
class ReportContent extends StatelessWidget {
  ...
  Widget _buttonSelectType(BuildContext context, ReportBloc bloc) {
    return Expanded(
      child: Center(
  ...
  Widget _valueBPM(BuildContext context, ReportBloc bloc) {
  ...
  Widget _graphValueBPM(BuildContext context, ReportBloc bloc) {
    //Osciloscopio
